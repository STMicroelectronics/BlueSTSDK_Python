...
htmlhelp_basename = 'BlueSTSDKdoc'
...
latex_documents = [
    (master_doc, 'BlueSTSDK.tex', u'BlueSTSDK Documentation',
     u'Davide Aliprandi', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'BlueSTSDK', u'BlueSTSDK Documentation',
     author, 'BlueSTSDK', 'One line description of project.',
     'Miscellaneous'),
]
